...
public class ValueSamplesTests
{
    ...
    public void StringAssertionExample()
    {
        ...
        fullName.Should().Be("Yasamin Ashoori");
        fullName.Should().NotBeEmpty();
        fullName.Should().StartWith("Yasaminn");
        fullName.Should().EndWith("Ashoori");
    }
    ...
    public void EnumerableObjectsAssertionExample()
    {
        ...
        users.Should().Contain(x => x.FullName.StartsWith("Yasamin") && x.Age > 5);
    }
